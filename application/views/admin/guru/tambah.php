	<div class="x_content">
	  <form class="form-horizontal form-label-left" action="<?=base_url('admin/guru/tambah')?>" method="POST" enctype="multipart/form-data">
		  	<div class="form-group">
		  		<label>Tanggal Lahir</label>
		      <input placeholder="Tanggal Lahir" name="tgl_lahir" class="form-control tanggal" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date" value="<?=set_value('tgl_lahir')?>">
		      ...
		      <input class="form-control" name="nig" placeholder="NIG" type="text" value="<?=set_value('nig')?>">
		      <?=form_error('nig','<p class="text-left" style="color:#FC624D!important;font-weight:bold;font-size:12px;">','</p>'); ?>	
		    </div>
		    <div class="form-group">
		      <label>Nama</label>
		      <input class="form-control" name="nama" placeholder="Nama" type="text" value="<?=set_value('nama')?>">
