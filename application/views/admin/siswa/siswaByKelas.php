...
<div class="x_content">
  ...
  <div class="col-md-6" style="padding:0px;">
    ...
    <a href="<?=base_url('admin/siswa/report_pdf_by_kelas/'.$siswa[0]->id_jurusan.'/'.$siswa[0]->daftar_kelas)?>" class="btn btn-primary" target="_blank"><i class="fa fa-file-pdf-o"></i></a>
    ...
    <div class="btn-group dropdown" style="margin-top:-5px;">
      ...
      <ul class="dropdown-menu" role="menu">
        ...
        <li style="font-size:14px;padding:5px"><a href="<?=base_url('admin/siswa/siswa_by_kelas/'.$s->id_jurusan.'/'.$s->daftar_kelas)?>" style="border-bottom:1px solid #EEEEEE;"><?=$s->daftar_kelas?></a></li>
        <?php endforeach ?>
      </ul>
    </div>
